...
\index{Abstract}%
\indent
This report evaluates two distinct methods of improving the performance of GPU memory systems. Over the past semester, my research has focused on applying the Hawkeye cache replacement policy on GPUs and exploring headroom of preemptively writing back dirty cache lines.
